...
/**
 * Implementation for testing context scope.
 *
 * @author <a href="mailto:cs@jdtaus.org">Christian Schulte</a>
 * @version $Id$
 */
public class ContextTestImplementation
    implements ContextTestSpecification, ContainerInitializer
{
    //--Implementation----------------------------------------------------------
...
// <editor-fold defaultstate="collapsed" desc=" Generated Code ">//GEN-BEGIN:jdtausConstructors
    ...
    /** Standard implementation constructor <code>org.jdtaus.core.container.ri.client.test.ContextTestImplementation</code>. */
    public ContextTestImplementation()
    {
        super();
    }
...
// <editor-fold defaultstate="collapsed" desc=" Generated Code ">//GEN-BEGIN:jdtausDependencies
     ...
     */
    private ContextTestSpecification getDependency()
    {
        return (ContextTestSpecification) ContainerFactory.getContainer().
